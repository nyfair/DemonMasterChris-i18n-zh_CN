# TODO: Translation updated at 2015-06-14 19:14
...
translate chinese strings:
    ...
    # renpy/common/00action_file.rpy:627
...
translate chinese strings:
    ...
    old "[i.j_name]レベルアップ[nw10]"
    new "[i.j_name]等级上升了[nw10]"

    old "[gain]エーテルを獲得[nw10]"
    new "获得[gain]以太[nw10]"

    old "[getitem.name!t]を入手[nw10]"
    new "获得[getitem.name!t][nw10]"